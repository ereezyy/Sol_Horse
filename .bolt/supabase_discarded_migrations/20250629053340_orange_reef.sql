/*
  # Marketplace Listings Setup
  
  1. New Tables
    - `players` - If not exists, creates basic player table
    - `marketplace_listings` - Stores all marketplace items for sale
  
  2. Indices
    - Added indices for common query patterns
    
  3. Security
    - Enabled RLS on marketplace_listings
    - Added policies for viewing and managing listings
*/
